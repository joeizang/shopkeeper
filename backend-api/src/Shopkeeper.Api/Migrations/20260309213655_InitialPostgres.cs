        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPulledAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    SentAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseDateUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BucketKey = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiryDate = table.Column<LocalDate>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDateUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayloadJson = table.Column<string>(type: "text", nullable: false),
                    ClientUpdatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    ServerUpdatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantSaleCounters", x => x.TenantId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportFileId = table.Column<Guid>(type: "uuid", nullable: true),
                    RequestedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    CompletedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: true),
                    UpdatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "bytea", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDateUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    OutstandingAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostPriceSnapshot = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    LastUsedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedShopId = table.Column<Guid>(type: "uuid", nullable: true),
                    TokenHash = table.Column<string>(type: "text", nullable: false),
                    ExpiresAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    ConsumedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: true),
                    RequestedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserAccountId = table.Column<Guid>(type: "uuid", nullable: false),
                    ShopMembershipId = table.Column<Guid>(type: "uuid", nullable: false),
                    TokenHash = table.Column<string>(type: "text", nullable: false),
                    ExpiresAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false),
                    RevokedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: true),
                    DeviceId = table.Column<string>(type: "text", nullable: true),
                    DeviceName = table.Column<string>(type: "text", nullable: true),
                    LastSeenAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: true),
                    CreatedAtUtc = table.Column<Instant>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
